...
from train import predict_with_tta
...
color_palette = np.array([
    ...
    [135, 206, 235],
    [255, 0, 255],  # Flowers (new class)  # Sky - sky blue
], dtype=np.uint8)
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default=os.path.join(script_dir, 'segmentation_head_best.pth'),
